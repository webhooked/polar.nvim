...
function lsp.highlights()
  return {
    ...
    DiagnosticHint = { fg = c.frost.arctic_water }, -- Used as the base highlight group. Other Diagnostic highlights link to this by default
    ...
    DiagnosticVirtualTextHint = { bg = utils.darken(c.frost.arctic_water, 0.1), fg = c.frost.arctic_water }, -- Used for "Hint" diagnostic virtual text
    ...
    DiagnosticUnderlineHint = { undercurl = true, sp = c.frost.arctic_water }, -- Used to underline "Hint" diagnostics
