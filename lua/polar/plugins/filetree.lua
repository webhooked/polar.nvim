...
function filetree.highlights()
  ...
  return {
    ...
    NvimTreeIndentMarker = { fg = c.frost.arctic_water },
    NvimTreeImageFile = { fg = c.snow_storm.origin },
    NvimTreeSymlink = { fg = c.frost.arctic_water },
    NvimTreeFolderIcon = { fg = c.frost.arctic_water },
    NvimTreeOpenedFolderName = { fg = c.snow_storm.origin },

    NeoTreeDimText = { fg = c.polar_night.brightest },
    NeoTreeDirectoryIcon = { fg = c.frost.arctic_water },
    ...
    NeoTreeSymbolicLinkTarget = { fg = c.frost.arctic_water },
