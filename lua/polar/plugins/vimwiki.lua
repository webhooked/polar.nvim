...
function vimwiki.highlights()
  return {
    ...
    VimwikiList = { fg = c.frost.arctic_water, bg = c.none },
    VimwikiTag = { fg = c.aurora.green, bg = c.none },
    VimwikiMarkers = { fg = c.frost.arctic_ocean, bg = c.none },
    VimwikiHeader1 = { fg = c.frost.arctic_ocean, bg = c.none, bold = true },
    VimwikiHeader2 = { fg = c.frost.arctic_water, bg = c.none, bold = true },
