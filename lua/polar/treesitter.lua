...
function treesitter.highlights()
  local options = require("polar.config").options
  ...
  return {
    ...
    ["@keyword.directive"] = { fg = c.frost.arctic_water }, --  various preprocessor directives & shebangs
    ["@preproc"] = { link = "@keyword.directive" }, -- @deprecated
    ["@keyword.directive.define"] = { fg = c.frost.arctic_water }, --  preprocessor definition directives
    ["@define"] = { link = "@keyword.directive.define" }, -- @deprecated
    ["@operator"] = { fg = c.frost.arctic_water }, --  symbolic operators (e.g. `+` / `*`)

    -- Punctuation
    ["@punctuation.delimiter"] = { fg = c.snow_storm.brightest }, --  delimiters (e.g. `;` / `.` / `,`)
    ["@punctuation.bracket"] = { fg = c.frost.ice }, --  brackets (e.g. `()` / `{}` / `[]`)
    ["@markup.list"] = { fg = c.frost.arctic_water }, --  special symbols (e.g. `{}` in string interpolation)
    ...
    ["@boolean"] = { fg = c.frost.arctic_water }, --  boolean literals
    ...
    -- Functions
    ["@function"] = vim.tbl_extend("force", { fg = c.frost.arctic_grass }, options.styles.functions), --  function definitions
    ["@function.builtin"] = { fg = c.frost.arctic_grass }, --  built-in functions
    ["@function.call"] = { fg = c.frost.arctic_grass }, --  function calls
    ["@function.macro"] = { fg = c.frost.arctic_water }, --  preprocessor macros
    ["@function.method"] = { fg = c.frost.arctic_grass }, --  method definitions
    ["@method"] = { link = "@function.method" }, -- @deprecated
    ["@function.method.call"] = { fg = c.frost.arctic_grass }, --  method calls
    ["@method.call"] = { link = "@function.method.call" }, -- @deprecated
    ["@constructor"] = { fg = c.frost.arctic_grass }, --  constructor calls and definitions
    ["@variable.parameter"] = { fg = c.frost.ice }, --  parameters of a function
    ["@parameter"] = { link = "@variable.parameter" }, -- @deprecated

    -- Keywords
    ["@keyword"] = vim.tbl_extend("force", { fg = c.frost.arctic_water }, options.styles.keywords), --  various keywords
    ["@keyword.function"] = vim.tbl_extend("force", { fg = c.frost.arctic_water }, options.styles.functions), --  keywords that define a function (e.g. `func` in Go, `def` in Python)
    ["@keyword.operator"] = vim.tbl_extend("force", { fg = c.frost.arctic_water }, options.styles.keywords), --  operators that are English words (e.g. `and` / `or`)
    ["@keyword.return"] = vim.tbl_extend("force", { fg = c.frost.arctic_water }, options.styles.keywords), --  keywords like `return` and `yield`
    ["@keyword.conditional"] = vim.tbl_extend("force", { fg = c.frost.arctic_water }, options.styles.keywords), --  keywords related to conditionals (e.g. `if` / `else`)
    ["@conditional"] = { link = "@keyword.conditional" }, -- @deprecated
    ["@keyword.repeat"] = vim.tbl_extend("force", { fg = c.frost.arctic_water }, options.styles.keywords), --  keywords related to loops (e.g. `for` / `while`)
    ...
    ["@keyword.import"] = vim.tbl_extend("force", { fg = c.frost.arctic_water }, options.styles.keywords), --  keywords for including modules (e.g. `import` / `from` in Python)
    ["@include"] = { link = "@keyword.import" }, -- @deprecated
    ["@keyword.exception"] = vim.tbl_extend("force", { fg = c.frost.arctic_water }, options.styles.keywords), --  keywords related to exceptions (e.g. `throw` / `catch`)
    ["@exception"] = { link = "@keyword.exception" }, -- @deprecated

    -- Types
    ["@type"] = { fg = c.frost.polar_water }, --  type or class definitions and annotations
    ["@type.builtin"] = { fg = c.frost.arctic_water }, --  built-in types
    ["@type.definition"] = { fg = c.frost.polar_water }, --  type definitions (e.g. `typedef` in C)
    ["@type.qualifier"] = { fg = c.frost.arctic_water }, --  type qualifiers (e.g. `const`)
    ["@keyword.storage"] = { fg = c.frost.arctic_water }, --  visibility/life-time modifiers
    ...
    ["@variable.builtin"] = { fg = c.frost.arctic_water }, --  built-in variable names (e.g. `this`)
    ["@constant"] = { fg = c.snow_storm.origin }, --  constant identifiers
    ["@constant.builtin"] = { fg = c.frost.arctic_water }, --  built-in constant values
    ["@constant.macro"] = { fg = c.frost.arctic_water }, --  constants defined by the preprocessor
    ...
    ["@markup.heading.1.markdown"] = { fg = c.frost.arctic_water, bold = true }, --  markdown h1
    ...
    ["@markup.environment.name"] = { fg = c.frost.arctic_water }, --  text indicating the type of an environment
    ...
    ["@comment.todo"] = { fg = c.frost.arctic_water }, --  todo notes
    ["@text.todo"] = { link = "@comment.todo" }, -- @deprecated
    ["@comment.note"] = { fg = c.frost.arctic_water }, --  info notes
    ...
    -- Tags
    ["@tag"] = { fg = c.frost.arctic_water }, --  XML tag names
    ["@tag.attribute"] = { fg = c.frost.polar_water }, --  XML tag attributes
    ["@tag.delimiter"] = { fg = c.frost.arctic_water }, --  XML tag delimiters
    ...
    ["@attribute.phpdoc"] = { fg = c.frost.arctic_water },
